...
import {
  moveScrollBarXCallBack,
  scrollBarXOnClickCallBack,
} from "../event/index";
...
export class ScrollBarX extends BaseBar {
  ...
  public paintScrollBar() {
    ...
    ctx.fillRect(0, ch - h, cw - safeArea, h);
    if (safeArea) {
      ctx.fillStyle = "#DCDCDC";
      ctx.fillRect(cw - safeArea, ch - h, BaseBar.BTNWIDTH, BaseBar.BTNWIDTH);
    }
